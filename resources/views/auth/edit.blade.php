...
<body>
    <div class="container mt-2">
        ...
        @include('error.error')
        <form action="{{ url('index/'.$setting->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Enter Title" value="{{ old('email') }}" required>
                    </div>
                </div> --}}
